...
/** Clés pour lesquelles une valeur non vide dans .env remplace une variable d’environnement vide (évite « sans token » si le shell exporte ""). */
const TOKENISH_KEYS = new Set(["API_KEY_PORTFOLIO", "GITHUB_TOKEN", "GH_TOKEN"]);

/**
 * Charge .env à la racine du projet (sans dépendance dotenv).
 */
